          ...
          <div className="row">
            ...
            <div className="col-lg-5 offset-lg-1 align-self-center">
              <div className="intro_txt">
                ...
                <p className="lead">
                  The customer is very important, the customer will be followed
                  by the customer. But the financing is free unless it is grid,
                  but it is the gate that will be pursued.
                </p>
                <p>
                  Doubts or irure pain in reprimanding in pleasure wants to be
                  let no hair flee from pain
                </p>
                <p>
                  <a href="#0" className="btn_1 medium gradient pulse_bt mt-2">
                    Register
